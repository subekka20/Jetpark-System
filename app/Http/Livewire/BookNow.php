...
class BookNow extends Component
{
    ...
    public function mount($customerId,$start_date,$end_date)
    {
        ...
        if ($booking_reference_last) {
            ...
            $reference = (int)str_replace('JP-#0000', '', $reference) + 1;
        } else {
            $reference = 1;
        }

        $this->new_booking_number = 'JP-#0000' . $reference;
    }
    ...
    public function saveData()
    {
        ...
        $this->validate(
            ...
            // Mail::to('airwingparkingbooking@gmail.com')->send(new ConfirmMail($content_data));
