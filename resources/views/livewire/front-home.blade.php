                                                            ...
                                                            <form>
                                                                ...
                                                                <div>
                                                                    <h6 class="mt-3 mb-3 text-left"
                                                                        style="font-weight:900; color:blue">Your
                                                                        Booking Amount
                                                                        is <b class="text-dark">Rs&nbsp;{{$total}}</b>
                                                                    </h6>
                                                                </div>
                ...
                <div class="item d-flex justify-content-center">
                    <div class="testimonial-item wow fadeInUp" data-wow-delay="0.2s"
                        ...
                        <div class="p-2 testimonial-comment"
                            style="background-color:  rgb(206, 247, 255); border-radius: 5px; max-height:60px;overflow-y: scroll;">
