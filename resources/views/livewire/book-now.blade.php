          ...
          <form class="tm-search-form tm-section-pad-2">
            ...
            <div _ngcontent-sbe-c66 class="row border border-gray-400 rounded py-4 px-1 my-4">
              <h5>
                Customer Details</h5>
              <label>
                * <font color="blue">Required Fields</font>
              </label>
              ...
              <div class="col-12 col-md-4 col-lg-4">
                <div class="form-group">
                  <select class="form-control @error('new_payment_method') is-invalid @enderror"
                    ...
                    <option value="Card">Card&nbsp;&nbsp;&nbsp;(Contact JetPark)
                    </option>
                  </select>
                </div>
              </div>
            ...
            <div class="row border border-gray-400 rounded py-4 px-1 my-4">
              <div class="mt-3">
                <div>
                  <h3 class="mt-2 mb-4 text-left" style="font-weight:900; color:blue">Your Booking Amount
                    is <b class="text-dark">Rs&nbsp;{{$total}}</b> </h3>
                </div>
                <div class="my-1 mx-0">
