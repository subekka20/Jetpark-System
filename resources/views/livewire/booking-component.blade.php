            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title " id="formModal">
                        Booking Information - <small style="color: #17cdda">{{ $view[0]->booking_number }}</small> </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-body">
                    <div class="row gutters-sm">
                        <div class="col-md-12">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <h4 class="mb-4" style="color: #17cdda; font-size:20px">
                                     <i style="color:black"> Rs </i>&nbsp;  Payment Details
                                    </h4>
                                    <div class="row">
                                        <div class="col-sm-5">
                                        ...
                                        <div class="col-sm-7 text-dark font-weight-bold">
                                            Rs {{ number_format($view[0]->paid_amount, 2)}}
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                    ...
                                    <hr>
                                    <div class="row pt-4 pb-4" style="background-color: #8bf7fc; border-radius:10px">
                                        <div class="col-sm-5">
