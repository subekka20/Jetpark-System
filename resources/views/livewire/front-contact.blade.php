...
<div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5 text-primary">JetPark - Airport Vehicle Parking
                </h1>
            </div>
            <div class="row g-4">
                <div class="col-12">
                        ...
                        <div class="col-md-6">
                            <div class="bg-light d-flex flex-column justify-content-center p-4">
                                ...
                                <p class="m-0"><i class="fa fa-envelope-open text-primary me-2"></i><a
                                        href="mailto:JetParkbooking@gmail.com" style="word-wrap: break-word;">
                                        JetParkbooking@gmail.com</a></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="bg-light d-flex flex-column justify-content-center p-4">
                                <h5 class="text-uppercase"> Contact Number</h5>
                                <p class="m-0"><i class="fa fa-phone text-primary me-2"></i><a href="tel:0756668326">
                                        075 666 8326</a></p>
                            </div>
                        </div>
                    </div>
    ...
    src="https://maps.google.com/maps?q=9.7924%2C80.0701&t=&z=13&ie=UTF8&iwloc=&output=embed"
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        ...
                                        <label for="name">Name<font color="blue">*</font></label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        ...
                                        <label for="email">Email<font color="blue">*</font></label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        ...
                                        <label for="Title">Title<font color="blue">*</font></label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
                                        ...
                                        <label for="message">Message<font color="blue">*</font></label>
                                    </div>
                                </div>
                                <div class="col-12">
