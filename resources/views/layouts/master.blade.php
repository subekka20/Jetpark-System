...
<head>
    ...
    <title>JetPark - Web Portal</title>
    <!-- General CSS Files -->
    ...
    <link rel='shortcut icon' type='image/x-icon' href="{{ asset('front_assets/img/logo1.jpeg') }}" />
    {{--
                ...
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="/dashboard"> <img alt="image" class="logo-image"
                                src="{{ asset('assets/img/logo1.jpeg') }}" width="40"
                                class="header-logo" />
                            <b class="logo-name JetPark-title">JetPark</b>
                        </a>
                    </div>
                    <ul class="sidebar-menu">
                        <li class="menu-header">HOME</li>
                        <li class=""><a class="nav-link" href="/" target="_blank">
                                <i data-feather="globe"></i><span><strong>JetPark</strong> - Web</span></a></li>
