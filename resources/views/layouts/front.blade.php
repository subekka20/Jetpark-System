...
<head>
    ...
    <!-- Favicon -->
    <link href="front_assets/img/logo1.jpeg" rel="icon">
        ...
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center py-3 me-4">
                    ...
                    JetPark &nbsp;
                    Near the Jaffna International Airport</a></small>
                </div>
            ...
            <div class="col-lg-5 px-5 text-end">
                <div class="h-100 d-inline-flex align-items-center py-3 me-4">
                    ...
                    <small><a href="tel:0756668326"> 075 666 8326
                    </a></small>
                </div>
                <div class="h-100 d-inline-flex align-items-center py-3 me-4">
                    <small class="fa fa-envelope text-primary me-2"></small>
                    <small><a href="mailto:JetParkbooking@gmail.com"> JetParkbooking@gmail.com
                    </a></small>
                </div>
            </div>
        </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="/" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary">
                <img height="55px" width="70px" src="{{ asset('front_assets/img/logo1.jpeg') }}">
                </h2>
        </a>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>&nbsp; JetPark
                    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Near the Jaffna International Airport </p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i><a href="tel:0756668326" class="text-white">075 666 8326</a></p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i><a href="mailto:JetParkbooking@gmail.com"class="text-white">JetParkbooking@gmail.com</a></p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy;&nbsp;<script>document.write(new Date().getFullYear())</script>&nbsp; <a class="border-bottom" href="#">JetPark</a>, All Right Reserved.
